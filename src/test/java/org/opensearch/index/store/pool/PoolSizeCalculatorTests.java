...
public class PoolSizeCalculatorTests extends OpenSearchTestCase {
    ...
    public void testCalculatePoolSizeWithDirectMemory() {
        Settings settings = Settings.builder().put(PoolSizeCalculator.NODE_POOL_SIZE_PERCENTAGE_SETTING.getKey(), 0.3).build();
    ...
    public void testCalculatePoolSizeWithCustomPercentage() {
        Settings settings = Settings.builder().put(PoolSizeCalculator.NODE_POOL_SIZE_PERCENTAGE_SETTING.getKey(), 0.5).build();
    ...
    public void testDirectMemoryAccountingInPoolCalculation() throws Exception {
        ...
        boolean hasDirectMemoryArg = jvmArgs.stream().anyMatch(arg -> arg.startsWith("-XX:MaxDirectMemorySize="));
    ...
    public void testCacheToPoolRatioCalculation() {
        ...
        // Test custom setting
        Settings customSettings = Settings.builder().put(PoolSizeCalculator.NODE_CACHE_TO_POOL_RATIO_SETTING.getKey(), 0.8).build();
    ...
    public void testWarmupPercentageCalculation() {
        ...
        // Test custom setting
        Settings customSettings = Settings.builder().put(PoolSizeCalculator.NODE_WARMUP_PERCENTAGE_SETTING.getKey(), 0.1).build();
