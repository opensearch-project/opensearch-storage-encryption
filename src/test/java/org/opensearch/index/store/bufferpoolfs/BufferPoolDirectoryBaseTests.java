...
/**
 * Runs Lucene's full 67-method directory contract test suite against BufferPoolDirectory.
 */
@ThreadLeakFilters(filters = CaffeineThreadLeakFilter.class)
public class BufferPoolDirectoryBaseTests extends OpenSearchBaseDirectoryTestCase {

    static final String KEY_FILE_NAME = "keyfile";

    @Override
    protected Directory getDirectory(Path file) throws IOException {
        return CryptoTestDirectoryFactory.createBufferPoolDirectory(file, org.apache.lucene.store.FSLockFactory.getDefault());
    }
