...
public class IndexTemplateIntegTests extends OpenSearchIntegTestCase {
    ...
    /**
     * Tests data stream with index template encryption.
     * Data streams automatically create backing indices using templates.
     *
     * NOTE: Data stream API may vary by OpenSearch version. Skipped for compatibility.
     */
    // public void testDataStreamWithTemplate() throws Exception {
    // // Skipped - data stream API compatibility issues across OpenSearch versions
    // }
    ...
    public void testMultipleRollovers() throws Exception {
        ...
        for (int i = 1; i < 5; i++) {
            String newIndexName = String.format("multi-rollover-%06d", i + 1);
