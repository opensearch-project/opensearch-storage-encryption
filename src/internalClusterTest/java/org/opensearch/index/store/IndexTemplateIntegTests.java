...
public class IndexTemplateIntegTests extends OpenSearchIntegTestCase {
    ...
    public void testPluginDisabledPreventsCryptofsIndices() throws Exception {
        ...
        Settings disabledSettings = Settings.builder().put(CryptoDirectoryPlugin.CRYPTO_DIRECTORY_ENABLED, false).build();
    ...
    public void testEnabledSettingConfiguration() throws Exception {
        ...
        boolean hasEnabledSetting = plugin
            .getSettings()
            .stream()
            .anyMatch(s -> s.getKey().equals(CryptoDirectoryPlugin.CRYPTO_DIRECTORY_ENABLED));
        ...
        assertEquals(
            ...
            Boolean.FALSE,
            CryptoDirectoryPlugin.CRYPTO_DIRECTORY_ENABLED_SETTING.getDefault(Settings.EMPTY)
        );
    ...
    public void testPluginStateConsistency() throws Exception {
        ...
        // Test enabled state
        Settings enabledSettings = Settings.builder().put(CryptoDirectoryPlugin.CRYPTO_DIRECTORY_ENABLED, true).build();
